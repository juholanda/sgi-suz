...
const ACAO_LABELS: Record<string, string> = {
  ...
  SOLICITACAO_ENVIADA: 'Solicitacao enviada para aprovacao',
  APROVACAO_REGISTRADA: 'Aprovacao registrada',
  PROXIMO_APROVADOR_NOTIFICADO: 'Proximo aprovador notificado',
  APROVACAO_COMPLETA: 'Aprovacao completa \u2014 execucao autorizada',
  REJEICAO_REGISTRADA: 'Solicitacao rejeitada',
  EXECUCAO_INICIADA: 'Execucao iniciada em campo',
  DESABILITACAO_CONFIRMADA: 'Desabilitacao confirmada',
  REABILITACAO_INICIADA: 'Reabilitacao iniciada',
  REABILITACAO_CONCLUIDA_EXECUTANTE: 'Reabilitacao concluida pelo executante \u2014 aguardando validacao',
  REABILITACAO_VALIDADA: 'Reabilitacao validada \u2014 solicitacao encerrada',
  REABILITACAO_REJEITADA: 'Reabilitacao devolvida para correcao',
  CANCELADA: 'Solicitacao cancelada',
  EXTENSAO_REGISTRADA: 'Extensao de prazo registrada',
  EXTENSAO_APROVADA: 'Extensao de prazo aprovada',
  EXTENSAO_REJEITADA: 'Extensao de prazo rejeitada',
}
