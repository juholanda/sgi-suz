...
const ACAO_LABELS: Record<string, string> = {
  ...
  PROXIMO_APROVADOR_NOTIFICADO: 'Notificacao enviada',
  APROVACAO_COMPLETA: 'Aprovacao completa',
  REJEICAO_REGISTRADA: 'Rejeicao registrada',
  ...
  REABILITACAO_CONCLUIDA_EXECUTANTE: 'Reabilitacao concluida',
  REABILITACAO_VALIDADA: 'Reabilitacao validada',
  REABILITACAO_REJEITADA: 'Reabilitacao rejeitada',
  CANCELADA: 'Cancelamento',
  EXTENSAO_REGISTRADA: 'Extensao registrada',
  EXTENSAO_APROVADA: 'Extensao aprovada',
  EXTENSAO_REJEITADA: 'Extensao rejeitada',
}
