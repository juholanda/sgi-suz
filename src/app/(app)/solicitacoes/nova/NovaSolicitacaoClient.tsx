...
interface NovaSolicitacaoClientProps {
  initialAreas: Area[]
  initialMedidas: MedidaContingencial[]
...
export default function NovaSolicitacaoClient({ initialAreas, initialMedidas, initialUserId }: NovaSolicitacaoClientProps) {
  ...
  // Dados externos — áreas e medidas já vêm pré-carregadas pelo Server Component
  ...
  const [medidas, setMedidas] = useState<MedidaContingencial[]>(initialMedidas)
